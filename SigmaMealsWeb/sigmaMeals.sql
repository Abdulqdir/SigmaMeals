...
INSERT INTO CONSISTS_OF
VALUES(353123, 10711111, 2000.0, '');
INSERT INTO CONSISTS_OF
VALUES(353123, 31015, 0.3333333333333333, 'cups');
INSERT INTO CONSISTS_OF
VALUES(353123, 18350, 4.0, '');
INSERT INTO CONSISTS_OF
...
INSERT INTO CONSISTS_OF
VALUES(629500, 1002044, 1.0, 'bunch');
INSERT INTO CONSISTS_OF
...
INSERT INTO CONSISTS_OF
VALUES(629500, 11282, 1.0, '');
INSERT INTO CONSISTS_OF
VALUES(629500, 9265, 2.0, '');
INSERT INTO CONSISTS_OF
...
WHERE INGREDIENT.ingredientid IN (
    SELECT IngredientID
    FROM INGREDIENT
    WHERE IngredientID = 453
      OR IngredientID = 452
      OR IngredientID = 9003
  )
  AND CONSISTS_OF.ingredientid = INGREDIENT.IngredientID
GROUP BY ing_name;
/*
 Query 3
...
FROM RECIPE,
  RATING
WHERE RECIPE.recipeid = RATING.recipeid
